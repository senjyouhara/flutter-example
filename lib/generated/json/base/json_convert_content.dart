...
class JsonConvert {
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    if (<HomeListDatas>[] is M) {
      return data.map<HomeListDatas>((Map<String, dynamic> e) =>
          HomeListDatas.fromJson(e)).toList() as M;
    }
    if (<HomeModel>[] is M) {
      return data.map<HomeModel>((Map<String, dynamic> e) =>
          HomeModel.fromJson(e)).toList() as M;
    }
    if (<HomeModelData>[] is M) {
      return data.map<HomeModelData>((Map<String, dynamic> e) =>
          HomeModelData.fromJson(e)).toList() as M;
    }
...
class JsonConvertClassCollection {
  Map<String, JsonConvertFunction> convertFuncMap = {
    (HomeListDatas).toString(): HomeListDatas.fromJson,
    (HomeModel).toString(): HomeModel.fromJson,
    (HomeModelData).toString(): HomeModelData.fromJson,
