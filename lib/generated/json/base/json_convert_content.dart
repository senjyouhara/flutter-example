...
class JsonConvert {
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    if (<HomeListModelEntity>[] is M) {
      return data.map<HomeListModelEntity>((Map<String, dynamic> e) =>
          HomeListModelEntity.fromJson(e)).toList() as M;
    }
    if (<HomeListModelDatas>[] is M) {
      return data.map<HomeListModelDatas>((Map<String, dynamic> e) =>
          HomeListModelDatas.fromJson(e)).toList() as M;
    }
    if (<HomeListModelDatasTags>[] is M) {
      return data.map<HomeListModelDatasTags>((Map<String, dynamic> e) =>
          HomeListModelDatasTags.fromJson(e)).toList() as M;
    }
    if (<HomeModelEntity>[] is M) {
      return data.map<HomeModelEntity>((Map<String, dynamic> e) =>
          HomeModelEntity.fromJson(e)).toList() as M;
    }
    if (<HomeTopListModel>[] is M) {
      return data.map<HomeTopListModel>((Map<String, dynamic> e) =>
          HomeTopListModel.fromJson(e)).toList() as M;
    }
    if (<FriendModelEntity>[] is M) {
      return data.map<FriendModelEntity>((Map<String, dynamic> e) =>
          FriendModelEntity.fromJson(e)).toList() as M;
    }
    if (<HotKeyModelEntity>[] is M) {
...
class JsonConvertClassCollection {
  Map<String, JsonConvertFunction> convertFuncMap = {
    (HomeListModelEntity).toString(): HomeListModelEntity.fromJson,
    (HomeListModelDatas).toString(): HomeListModelDatas.fromJson,
    (HomeListModelDatasTags).toString(): HomeListModelDatasTags.fromJson,
    (HomeModelEntity).toString(): HomeModelEntity.fromJson,
