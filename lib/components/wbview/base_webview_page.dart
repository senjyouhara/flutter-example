...
import 'package:example/components/wbview/base_webview_widget.dart';
...
class _BaseWebViewPageState extends State<BaseWebViewPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: widget.showTitle == false ? null : AppBar(title: _buildAppbarTitle(widget.title),),
      body: SafeArea(child: BaseWebViewWidget(webviewType: widget.webviewType, loadResource: widget.loadResource, jsChannelMap: widget.jsChannelMap,)),
    );
  }
