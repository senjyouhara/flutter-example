...
// 下面这两个模板方法，就按照官方文档这么定义就好，用来自动生成解析代码
  factory HomeListModel.fromJson(Map<String, dynamic> json) => _$HomeListModelFromJson(json);
...
class HomeListDatas {
  ...
  HomeListDatas();
// 下面这两个模板方法，就按照官方文档这么定义就好，用来自动生成解析代码
  factory HomeListDatas.fromJson(Map<String, dynamic> json) => _$HomeListDatasFromJson(json);
  Map<String, dynamic> toJson() => _$HomeListDatasToJson(this);
...
/// id : 30283
/// isAdminAdd : false
/// link : "https://www.wanandroid.com/blog/show/3797"
/// niceDate : "2025-07-26 00:00"
/// niceShareDate : "2025-07-26 00:10"
/// origin : ""
/// prefix : ""
/// projectLink : ""
/// publishTime : 1753459200000
/// realSuperChapterId : 542
/// selfVisible : 0
/// shareDate : 1753459800000
/// shareUser : ""
/// superChapterId : 543
/// superChapterName : "技术周报"
/// tags : []
/// title : "Android 技术周刊 （2025-07-19 ~ 2025-07-26）"
/// type : 0
/// userId : -1
/// visible : 1
/// zan : 0
...
class HomeListData {
  ...
  num? _visible;
  num? _zan;
HomeListData copyWith({  bool? adminAdd,
  String? apkLink,
  num? audit,
  String? author,
  bool? canEdit,
  ...
  num? visible,
  num? zan,
}) => HomeListData(  adminAdd: adminAdd ?? _adminAdd,
