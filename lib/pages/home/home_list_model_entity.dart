...
class HomeListModelEntity {
  ...
  factory HomeListModelEntity.fromJson(Map<String, dynamic> json) =>
      $HomeListModelEntityFromJson(json);
...
class HomeListModelDatas {
  ...
  factory HomeListModelDatas.fromJson(Map<String, dynamic> json) =>
      $HomeListModelDatasFromJson(json);
...
class HomeListModelDatasTags {
  ...
  factory HomeListModelDatasTags.fromJson(Map<String, dynamic> json) =>
      $HomeListModelDatasTagsFromJson(json);
