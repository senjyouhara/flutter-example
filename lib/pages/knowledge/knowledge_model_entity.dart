...
class KnowledgeModelEntity {
  ...
  factory KnowledgeModelEntity.fromJson(Map<String, dynamic> json) =>
      $KnowledgeModelEntityFromJson(json);
...
class KnowledgeModelDatas {
  ...
  factory KnowledgeModelDatas.fromJson(Map<String, dynamic> json) =>
      $KnowledgeModelDatasFromJson(json);
