...
class SearchModelDatas {
  ...
  factory SearchModelDatas.fromJson(Map<String, dynamic> json) =>
      $SearchModelDatasFromJson(json);
...
class SearchModelDatasTags {
  ...
  factory SearchModelDatasTags.fromJson(Map<String, dynamic> json) =>
      $SearchModelDatasTagsFromJson(json);
